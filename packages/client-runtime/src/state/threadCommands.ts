...
export function createThreadEnvironmentAtoms<R, E>(
  ...
  const commands = {
    ...
    retractTurn: createEnvironmentCommand(runtime, {
      label: "environment-data:commands:thread:retract-turn",
      execute: (input: RetractThreadTurnInput) => retractThreadTurn(input),
      scheduler,
      concurrency,
    }),
